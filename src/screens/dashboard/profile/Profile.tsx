...
import { useDeleteRequestMutation, useLazyGetTodoQuery, useLazyPatchRequestQuery, usePostDataMutation } from 'src/redux/service/GetFakeData';
...
function Profile(props): JSX.Element {
    ...
    return (
        <View style={styles.mainContainer}>
            ...
            />
            {isLoading ? <ActivityIndicator size={'large'} color={COLORS.THEME} style={styles.activityIndicator} />
